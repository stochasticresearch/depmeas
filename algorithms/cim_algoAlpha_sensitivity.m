function [sensitivityResults] = cim_algoAlpha_sensitivity(cimfunc, M, msiValue, alphasToTest)
...
sensitivityResults = cell(1,length(alphasToTest));
...
for alphaIdx=1:length(alphasToTest)
    ...
    for l=noiseVec
        dispstat(sprintf('Computing for noise level=%d >> M=%d alpha=%0.02f',l,M,alphaVal),'keepthis', 'timestamp');
        t1 = 0; c1 = 0; c11 = 0;
        t2 = 0; c2 = 0; c22 = 0;
        t3 = 0; c3 = 0; c33 = 0;
        t4 = 0; c4 = 0; c44 = 0;
        ...
        parfor mcSimNum=1:numMCSim
            ...
            c11 = c11 + cimfunc(x,y1,msiValue,alphaVal);
            ...
            c22 = c22 + cimfunc(x,y2,msiValue,alphaVal);
            ...
            c33 = c33 + cimfunc(x,y3,msiValue,alphaVal);
            ...
            c44 = c44 + cimfunc(x,y4,msiValue,alphaVal);
            ...
            c55 = c55 + cimfunc(x,y5,msiValue,alphaVal);

            t6 = t6 + abs(corr(x,y6,'type','kendall'));
            c6 = c6 + abs(corr(x,y6,'type','kendall'));
            c66 = c66 + cimfunc(x,y6,msiValue,alphaVal);
